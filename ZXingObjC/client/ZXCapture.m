        ...
        if (result) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                for(symbol in [read scanImage:cgImageRef]){
                    ZXBarcodeFormat format = (ZXBarcodeFormat)[ZXCapture ZbarResultValueToZxing:symbol.type];
                    result = [[ZXResult alloc] initWithText:symbol.data rawBytes:nil resultPoints:nil format:format];
                }
...
+ (NSInteger)ZbarResultValueToZxing:(NSInteger)format {
    ...
    ZXBarcodeFormat resultFormat = -1;
    
    switch (format) {
        case ZBAR_EAN2:                 /**< GS1 2-digit add-on */
        case ZBAR_EAN5:                 /**< GS1 5-digit add-on */
        case ZBAR_ISBN10:               /**< ISBN-10 (from EAN-13). @since 0.4 */
        case ZBAR_ISBN13:               /**< ISBN-13 (from EAN-13). @since 0.4 */
        case ZBAR_COMPOSITE:            /**< EAN/UPC composite */
        case ZBAR_NONE:                 /**< no symbol decoded */
        case ZBAR_PARTIAL:              /**< intermediate status */
        case ZBAR_I25:                  /**< Interleaved 2 of 5. @since 0.4 */
        case ZBAR_DATABAR:              /**< GS1 DataBar (RSS). @since 0.11 */
        case ZBAR_DATABAR_EXP:          /**< GS1 DataBar Expanded. @since 0.11 */
            break;
        case ZBAR_EAN8:                 /**< EAN-8 */
            resultFormat = kBarcodeFormatEan8;
            break;
        case ZBAR_UPCE:                 /**< UPC-E */
            resultFormat = kBarcodeFormatUPCE;
            break;
        case ZBAR_UPCA:                 /**< UPC-A */
            resultFormat = kBarcodeFormatUPCA;
            break;
        case ZBAR_EAN13:                /**< EAN-13 */
            resultFormat = kBarcodeFormatEan13;
            break;
        case ZBAR_CODABAR:              /**< Codabar. @since 0.11 */
            resultFormat = kBarcodeFormatCodabar;
            break;
        case ZBAR_CODE39:               /**< Code 39. @since 0.4 */
            resultFormat = kBarcodeFormatCode39;
            break;
        case ZBAR_PDF417:               /**< PDF417. @since 0.6 */
            resultFormat = kBarcodeFormatPDF417;
            break;
        case ZBAR_QRCODE:               /**< QR Code. @since 0.10 */
            resultFormat = kBarcodeFormatQRCode;
            break;
        case ZBAR_CODE93:               /**< Code 93. @since 0.11 */
            resultFormat = kBarcodeFormatCode93;
            break;
        case ZBAR_CODE128:              /**< Code 128 */
            resultFormat = kBarcodeFormatCode128;
            break;
        default:
            break;
    }
